...
<div style="width:900px; height:620px; max-width:95vw; max-height:85vh; background-color:#e0d0a0; border-radius: 4px 18px 5px 22px / 20px 6px 15px 8px; box-shadow: inset 0 0 80px rgba(100,70,30,0.7), inset 0 0 20px rgba(80,50,20,0.5), 0 20px 50px rgba(0,0,0,0.8); position:relative; overflow:visible; border: 4px solid #8c734b; transform: rotate(-0.5deg);">
    ...
    <svg style="position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;z-index:2;" viewBox="0 0 900 620">
        <!-- Trail 1 (Village) to 2 (Town) -->
        <path d="M 270 480 C 300 480, 300 350, 340 350" stroke="#8a7b45" stroke-width="6" fill="none" stroke-linecap="round" stroke-dasharray="12,12" opacity="0.8"/>
        <!-- Trail 2 (Town) to 3 (Castle) -->
        <path d="M 475 250 C 475 180, 740 300, 740 240" stroke="#8a7b45" stroke-width="6" fill="none" stroke-linecap="round" stroke-dasharray="12,12" opacity="0.8"/>
    </svg>
    ...
    <!-- Legend -->
    <div style="position:absolute;bottom:25px;right:25px;width:190px;background:#fdf5e6;padding:22px;border:1px solid #d3c7a3;box-shadow:3px 5px 14px rgba(0,0,0,0.35);font-family:'Kalam',cursive;font-size:18px;color:#333;transform:rotate(-2deg);z-index:4;">
        <div style="position:absolute;top:-16px;left:50%;transform:translateX(-50%);font-size:30px;filter:drop-shadow(0px 2px 2px rgba(0,0,0,0.4));">📌</div>
        <div style="font-weight:bold;margin-bottom:14px;border-bottom:2px dashed #c5b88a;padding-bottom:6px;font-size:24px;">Legend</div>
